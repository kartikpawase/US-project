    ...
    <div class="gh-top-bar bg-gh-navy text-white">
        <div class="gh-container d-flex justify-content-between align-items-center flex-wrap">
            ...
            <div class="gh-top-social d-none d-md-flex align-items-center gap-3">
                <a href="#" class="gh-social-link text-white-50" aria-label="Facebook" data-bs-toggle="modal" data-bs-target="#comingSoonModal">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/>
                    </svg>
                </a>
                <a href="#" class="gh-social-link text-white-50" aria-label="Instagram" data-bs-toggle="modal" data-bs-target="#comingSoonModal">
                ...
                <a href="#" class="gh-social-link text-white-50" aria-label="LinkedIn" data-bs-toggle="modal" data-bs-target="#comingSoonModal">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="#" class="gh-social-link text-white-50" aria-label="YouTube" data-bs-toggle="modal" data-bs-target="#comingSoonModal">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div class="gh-container d-flex align-items-center justify-content-between">
            ...
            <div class="collapse navbar-collapse" id="ghNavbarContent">
                ...
                <div class="d-flex align-items-center mt-3 mt-lg-0">
                    <button type="button" class="btn-gh btn-gh-green btn-gh-sm w-100 w-lg-auto" data-bs-toggle="modal" data-bs-target="#comingSoonModal">
                        PARTNER WITH US
