    ...
    <div class="gh-container">
        <div class="row g-4 align-items-stretch">
            ...
            <div class="col-12 col-lg-6 gh-quality-col">
                <div class="gh-quality-card h-100 d-flex flex-column justify-content-between p-4 rounded-4 bg-white shadow-sm border border-light-subtle">
                    <div>
                        ...
                        <p class="gh-quality-desc text-muted mb-4">
                    ...
                    <!-- 6 Quality Badges Grid (Responsive 3x2 on Desktop/Tablet, 2x3 on Mobile) -->
                    <div class="row g-2 g-sm-3 my-auto py-2">
                        <!-- 1. cGMP CERTIFIED -->
                        <div class="col-6 col-sm-4">
                            <div class="gh-quality-badge-item text-center p-3 rounded-3 bg-light h-100 border border-light-subtle d-flex flex-column align-items-center justify-content-center">
                                <div class="gh-quality-badge-icon mb-2 text-gh-green">
                        ...
                        <div class="col-6 col-sm-4">
                            <div class="gh-quality-badge-item text-center p-3 rounded-3 bg-light h-100 border border-light-subtle d-flex flex-column align-items-center justify-content-center">
                                <div class="gh-quality-badge-icon mb-2 text-gh-blue">
                        ...
                        <div class="col-6 col-sm-4">
                            <div class="gh-quality-badge-item text-center p-3 rounded-3 bg-light h-100 border border-light-subtle d-flex flex-column align-items-center justify-content-center">
                                <div class="gh-quality-badge-icon mb-2 text-gh-orange">
                    ...
                    <div class="gh-quality-footnote micro-text text-muted mt-3">
            ...
            <div class="col-12 col-lg-6 gh-partnership-col">
                <div class="gh-partnership-card h-100 p-4 rounded-4 bg-white shadow-sm border border-light-subtle">
                    <div class="row g-4 align-items-center h-100">
                        
                        <!-- Left: Checklist & CTA -->
                        <div class="col-12 col-md-7 d-flex flex-column justify-content-between h-100">
                            <div>
                                ...
                                <ul class="gh-partnership-list list-unstyled mb-4">
                        ...
                        <!-- Right: Handshake photo (Bounded height, object-fit cover, zero overflow) -->
                        <div class="col-12 col-md-5 d-flex flex-column h-100">
                            <div class="gh-handshake-img-wrap flex-grow-1 rounded-3 overflow-hidden shadow-sm position-relative">
